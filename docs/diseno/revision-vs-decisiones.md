...
- **El modelo de estado coincide exactamente** con
  [resolución de estado](../conceptos/resolucion-de-estado.md): cuatro capas,
...
- **El control plane que define es la superficie del MCP.** `GET/PUT
  ...
  [ADR-0006](../decisiones/0006-servidor-mcp.md). Confirma la tesis de que se
  implementa una vez y se expone por tres superficies.
- **`"GET /users"` como ID de endpoint** es exactamente el formato del
  [ADR-0003](../decisiones/0003-json-declarativo.md). Las capturas muestran
...
- **Compartir apagado por defecto, cada sesión, y token enmascarado** coincide
  con el [ADR-0007](../decisiones/0007-url-publica.md).
...
El [ADR-0007](../decisiones/0007-url-publica.md) ya lo exige ("el editor web y
...
El [ADR-0003](../decisiones/0003-json-declarativo.md) lo había resuelto haciendo
...
[tres-escritores](../conceptos/tres-escritores.md), que dice "falla ruidosamente
al arrancar" y se puede leer como *fail-fast*. Reiniciar todo el mock porque un
...
[ADR-0003](../decisiones/0003-json-declarativo.md) decía `laqi.json` o `laqi/`.
