...
**Spec:** [`docs/decisiones/`](../decisiones/) (ADRs 0001–0008), [`docs/conceptos/`](../conceptos/), [`docs/diseno/STATE-MODEL.md`](../diseno/STATE-MODEL.md)
...
Escribe `.laqi/state.json`, gitignored ([ADR-0004](../decisiones/0004-estado-fuera-de-git.md)). Es un archivo que genera la máquina: si está corrupto se descarta y se empieza de cero, nunca se cae el servidor.
...
El corazón del producto. Ver [`docs/diseno/STATE-MODEL.md`](../diseno/STATE-MODEL.md).
...
Convierte el formato de v1, incluido el hack `(get)files/:id`. Es lo que hace del [ADR-0001](../decisiones/0001-rewrite-v2.md) una migración y no una ruptura.
...
- **Templating `{{uuid}}` / `{{name}}`** ([ADR-0003](../decisiones/0003-json-declarativo.md)). v1 tenía `(generate:uid)` sin implementar; v2 lo implementa, pero en un plan posterior.
...
- **Escape hatch en TypeScript** para endpoints con lógica ([ADR-0003](../decisiones/0003-json-declarativo.md)): sin plan asignado todavía.
