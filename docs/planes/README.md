...
| 2a | [Control plane](2026-08-24-02a-control-plane.md) | `/__laqi/api/*` (CRUD de endpoints, estado, escenarios, status), SSE de requests en vivo, sobre `packages/server`. La separación estructural que el Plan 4 necesita para excluir `/__laqi` del túnel (H1) — el bloqueo en sí es responsabilidad de ese plan. **11 tareas, 50 tests nuevos.** | **Listo para ejecutar** |
