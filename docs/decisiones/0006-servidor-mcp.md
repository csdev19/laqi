...
El *control plane* que necesita el editor web —listar rutas, cambiar estado,
...
no puede cambiar estado sin ensuciar git (ver [ADR-0004](0004-estado-fuera-de-git.md)).
...
- Un agente con estas herramientas puede escribir archivos del proyecto. Debe
  ...
  defecto 4.4 del [análisis de v1](../analisis-v1.md)).
