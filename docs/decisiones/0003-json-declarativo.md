...
**Estado:** Aceptada — parcialmente superada por [ADR-0008](0008-multiarchivo-y-nombres.md)
**Fecha:** 2026-08-24

> **Nota:** el modo carpeta con *routing por filesystem* descrito abajo fue
> reemplazado por el [ADR-0008](0008-multiarchivo-y-nombres.md): cualquier
...
El argumento completo está en [los tres escritores](../conceptos/tres-escritores.md).
Resumido:
