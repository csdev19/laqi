...
**Estado:** Aceptada
**Fecha:** 2026-08-24
**Supera:** la parte de routing por filesystem del [ADR-0003](0003-json-declarativo.md)

## Contexto

El [ADR-0003](0003-json-declarativo.md) definió dos modos: un archivo único con
...
[tres-escritores](../conceptos/tres-escritores.md)).
...
otro lado: el [ADR-0006](0006-servidor-mcp.md) suma `create_scenario` y
