...
existe está en [ADR-0004](../decisiones/0004-estado-fuera-de-git.md).
...
- **Varias personas en la misma URL pública.** Tú mandas `X-Laqi-Response: boom`
  desde tu app y ves el 500; la diseñadora, en el mismo túnel, sigue viendo el
  200. En v1 esto era imposible.
