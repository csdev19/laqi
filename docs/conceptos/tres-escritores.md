...
([ADR-0003](../decisiones/0003-json-declarativo.md)), dónde vive el estado
([ADR-0004](../decisiones/0004-estado-fuera-de-git.md)) y por qué la validación
...
[ADR-0003](../decisiones/0003-json-declarativo.md).
...
[análisis de v1](../analisis-v1.md) son exactamente esto: entradas inválidas que
...
[ADR-0004](../decisiones/0004-estado-fuera-de-git.md).
