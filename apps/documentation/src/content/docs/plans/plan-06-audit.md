...
| 7   | Medium   | The walkthrough claims the generated `title` "reads like a real sentence". It is Latin lorem ipsum (`"truculenter doloribus eveniet"`). Either the copy or the rule should change.                                                                          | `trying-v2.md` step 6                                                  |
