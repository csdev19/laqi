---
title: F5 — Edit an endpoint definition
---

# F5 — Edit an endpoint definition

**Frequency** a few per day · **Cost target** cheap in _and_ out ·
...
3. **Left column** — every response, status-coloured, marker on the live one.
   Selecting one loads it for editing and _does not_ change what is live: the
